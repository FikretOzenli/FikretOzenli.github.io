 ...
 ]},
{
 ...
 "blocks":[
   ...
   ("fig","fig15.jpg","Figure 15 — Internal arrangement with top casing hidden"),
   ("fig","fig16.jpg","Figure 16 — Latched position on LHS, released position on RHS"),
 ]},
{
 "slug":"phone-stand",
 ...
 "blocks":[
   ...
   ("fig","fig17.jpg","Figure 17 — Complete assembly, without and with phone"),
   ("fig","fig18.jpg","Figure 18 — Base, intermediate part, rotation disc, cap and holder case"),
 ]},
]
